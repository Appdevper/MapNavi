 ...
 */
public class BudFragment extends Fragment implements View.OnClickListener, ServiceCallback {

    private static BudFragment instance;
    ...
    private String url = "http://isarapanich.com/note/map/b";

    public static BudFragment getInstance(CallbackView callback) {
        if (instance == null) {
            instance = new BudFragment();
        }
