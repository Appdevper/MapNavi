 ...
 */
public class PlaceFragment extends Fragment implements View.OnClickListener, ServiceCallback {
    ...
    public static PlaceFragment getInstance(CallbackView callback) {
        if (instance == null) {
