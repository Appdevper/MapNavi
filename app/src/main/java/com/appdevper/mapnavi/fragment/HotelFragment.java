 ...
 */
public class HotelFragment extends Fragment implements View.OnClickListener, ServiceCallback {
    ...
    private String url = "http://isarapanich.com/note/map/h";

    public static HotelFragment getInstance(CallbackView callback) {
        if (instance == null) {
            instance = new HotelFragment();
        }
