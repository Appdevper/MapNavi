 ...
 */
public class ShopFragment extends Fragment implements View.OnClickListener, ServiceCallback {
    ...
    private String url = "http://isarapanich.com/note/map/s";

    public static ShopFragment getInstance(CallbackView callback) {
        if (instance == null) {
